...
class MyWindow(QMainWindow, Form):
    def __init__(self):
        ...
        self.dx = (self.c / self.fp) / 10.
        self.dy = (self.c / self.fp) / 10.
    ...
    def start(self):
        ...
        cn = 1 / math.sqrt(2)
        self.dt = cn * self.dx / self.c / math.sqrt(2)  # Time
        print("test")
        print(self.dt)
        ...
        if self.flag == True:
            ...
            print(5)
            dic_wave = {'nt': self.nt, 'dt': self.dt,
...
class PlotThread(QtCore.QThread, MyWindow):
    ...
    def run(self):
        ...
        for it in range(1, int(self.nt + 1)):
            ...
            print('r2')
            source = self.A *np.sin(2.0*np.pi * self.fc * t)
